...
Runs Product Extraction Pipeline:
- productExtractionPipeline.py - Extracts products using saved templates
...
class PipelineManager:
    """
    Manages Product Extraction Pipeline
    """
    ...
    def start(self):
        ...
        print("\n[INFO] Press Ctrl+C to stop pipeline\n")
    ...
    def stop(self):
        ...
        print("[*] Waiting for pipeline to finish current operations...")
        time.sleep(2)
...
if __name__ == "__main__":
    ...
    print(f"{'='*80}")
    print("\nThis script runs Product Extraction Pipeline:")
    print("  Product Extraction Pipeline - Extracts products using saved templates")
    print(f"{'='*80}\n")
